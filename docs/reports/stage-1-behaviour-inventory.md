...
Result: **132 tests passed in 18 files** after temporarily linking the checked-
...
validator. It also provides a parity assertion: native/WASM or Node/Deno
records must agree on source identity, generated bytes, diagnostics and public
stop status while retaining host-specific measurements.
